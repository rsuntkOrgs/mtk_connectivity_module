...
static const uint16_t g_u2CountryGroup1[] = {
	...
	COUNTRY_CODE_ZM,
        COUNTRY_CODE_GD, COUNTRY_CODE_FM, COUNTRY_CODE_BM, COUNTRY_CODE_LC,
        COUNTRY_CODE_VC, COUNTRY_CODE_KN, COUNTRY_CODE_SX, COUNTRY_CODE_HT,
        COUNTRY_CODE_AI, COUNTRY_CODE_HN, COUNTRY_CODE_KY, COUNTRY_CODE_TW,
        COUNTRY_CODE_BS
};
...
static const uint16_t g_u2CountryGroup3[] = {
	COUNTRY_CODE_AS, COUNTRY_CODE_CU, COUNTRY_CODE_DM,
	COUNTRY_CODE_GT, COUNTRY_CODE_GU, COUNTRY_CODE_MP, COUNTRY_CODE_PR,
